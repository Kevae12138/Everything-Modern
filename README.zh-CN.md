...
[下载 Everything Modern v0.1.2](https://github.com/Kevae12138/Everything-Modern/releases/tag/v0.1.2)

使用方式：

1. 下载 `Everything-Modern-v0.1.2-win-x64.zip`
2. 解压压缩包
...
- 支持将分类放置在桌面分类模块顶部或底部
- 支持水平模式下每行 1 到 6 个分类
- 支持三种分类标签样式：整块填充、名称色块、名称下划线
- 支持右键分类，单独设置该分类的文字、填充、下划线和名称色块颜色
- 给桌面项目分配分类时，使用与全局筛选一致的自定义下拉框
- 非编辑模式下保持更简洁的展示
